    ...
    <section className="min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in">
        ...
        <p className="text-lg text-foreground/80 mb-12 max-w-2xl mx-auto leading-relaxed">
          Dynamic and detail-oriented Web Developer with over 3+ years of experience in PHP, HTML, CSS, JavaScript, WordPress,
          Laravel, and CodeIgniter. Proficient in Git version control, MySQL, and server-based deployment, with a strong focus on building
          secure, scalable, and high-performing web applications. Passionate about continuous learning and eager to contribute technical
          expertise to Eversun Software Corporation by delivering reliable and business-driven web solutions.
        </p>
